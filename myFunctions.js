...
function validateForm() {
    ...
    if (nationalId.trim() === '' || nationalId.length !== 11 ||
    ...
    (fullName.trim() !== '' && !validateArabicName(fullName)) || (birthdate.trim() !== '' && !isValidDate(birthdate)) || (mobileNumber.trim() !== '' && !isValidPhoneNumber(mobileNumber)) || (email.trim() !== '' && !validateEmail(email)) || (captchaInput.trim() !== '' && captchaInput !== correctCaptcha)) {
